...
class PDFMerger {
     ...
     * @return PDFMerger
     */
    public function addPDF($filepath, $pages = 'all', $orientation = 'horizontal') {
       ...
       if (!isset($this->_files) || !is_array($this->_files)) {
        ...
        foreach ($this->_files as $file) {
            ...
            try {
                ...
                // echo "Eroor"; exit;
                // var_dump($file); exit;
                $oldName= explode(".pdf", $filename);
                $newName=$oldName[0]."-copia.pdf";
                shell_exec( "gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dNOPAUSE -dQUIET -dBATCH -sOutputFile=".$newName." ".$filename." ");
                $count = $fpdi->setSourceFile($newName);
                $filename= $newName;
            }
