...
class consulta {
	...
	public function connect() {
       ...
       $link =  mysqli_connect($db_host,$db_user,$db_password, $db_name ) or die(http_response_code(503)?'No se pudo conectar: ' . mysqli_error($link):'');
        ...
        $rsTotal = mysqli_query($link,$sqlTotal);
	...
	public function connect2() {
	    global $MY_CONFIG;
		include("/home/sigesproph/public_html/config/config.db.php");
	...
	public function connect3($host,$user,$pass,$db) {
 		 ...
 		 $link =  mysqli_connect($host,$user,$pass, $db ) or die(http_response_code(503)?'No se pudo conectar: ' . mysqli_error($link):'');
        mysqli_select_db($link,$db) or die(http_response_code(403)?'No se pudo seleccionar la base de datos':'');
