<?php
	...
	class Contabilizar{
		...
		private function CrearMovimientosFacturaMultitipo($datos){
			...
			if (strtolower($facturaObj['Tipo_Dispensacion']) != 'evento'  && strtolower($facturaObj['Tipo_Dispensacion']) != 'positiva'  && strtolower($facturaObj['Tipo_Dispensacion']) != 'cohortes') {
 ...
 */
			...
			TotalIvaProductosNota($productos, 'factura venta', $nroFactura,
						 $this->id_modulo, $this->id_registro_modulo,$this->nit,$this->tipo_nit,$this->centro_costo,$this->save_fecha,$id_modulo_nota);	
		}
		...
		private function GuardarMovimientoNotaCreditoGlobalFactura($idFactura, $tipo_factura_nopos,$cuota_moderadora,$datos_dis){
			...
			TotalIvaProductosNota($productos_nota, 'factura', $nota['Codigo'],
			$this->id_modulo,$this->id_registro_modulo, $this->nit, $this->tipo_nit,$this->centro_costo,$this->save_fecha ,$id_modulo_nota);
