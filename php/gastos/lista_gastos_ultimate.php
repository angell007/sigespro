...
if (isset($_REQUEST['Identificacion_Funcionario']) && $_REQUEST['Identificacion_Funcionario'] != '') {
    $condicion .= " AND GP.Identificacion_Funcionario = $_REQUEST[Identificacion_Funcionario]";
}

$query = "SELECT 

   
GP.Id_Gasto_Punto, GP.Fecha, F.Nombre_Funcionario, PD.Nombre AS Punto_Dispensacion, 
...
GP.Fecha_Aprobacion, F2.Nombre_Funcionario AS Funcionario_Aprobacion,
 ...
 INNER JOIN
  ...
  WHERE TIMESTAMPDIFF(DAY, DATE(GP.Fecha), CURRENT_DATE()  ) > 8 AND GP.Estado = 'Pendiente'";
