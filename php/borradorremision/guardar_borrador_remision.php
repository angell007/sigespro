...
$idborrador=( isset( $_REQUEST['idborrador'] ) ? $_REQUEST['idborrador'] : '' );
        ...
        if($producto['Lotes_Seleccionados']!=null){
            ...
            if($lote['Id_Inventario']!=0){
                ...
                if($lote["Id_Categoria"]==3){$j++;
                        ...
                        $refrigerados[$j]["Precio"]=$producto["Precio_Venta"]!='' ? number_format($producto["Precio_Venta"],2,".","") : 0;
                        ...
                        $oItem->Cantidad_Total = $producto["Cantidad"]!='' ? $producto["Cantidad"] : 0;
                        ...
                        $oItem->Subtotal =$subtotal!='' ? number_format($subtotal,2,".","") : 0 ;
                        $oItem->save();
                        unset($oItem);
                        $items++;
                    }
