<?php
    ...
    $query = 'SELECT I.Id_Documento_Inventario_Fisico, I.Fecha_Inicio, I.Fecha_Fin, I.Estado,
    ...
    FROM Z_Documento_Inventario_Fisico_Nuevo I
    INNER JOIN Funcionario FD ON I.Funcionario_Digita = FD.Identificacion_Funcionario
    INNER JOIN Funcionario FC ON I.Funcionario_Cuenta = FC.Identificacion_Funcionario
    INNER JOIN Bodega B ON I.Id_Bodega = B.Id_Bodega
    LEFT JOIN Categoria C ON I.Id_Categoria = C.Id_Categoria
    LEFT JOIN Subcategoria S ON S.Id_Subcategoria = I.Id_Subcategoria
    '.$condicion.'
    ORDER BY I.Id_Documento_Inventario_Fisico DESC';

    $query_count = '
        SELECT 
            COUNT(I.Id_Documento_Inventario_Fisico) AS Total
            FROM Z_Documento_Inventario_Fisico_Nuevo I
            INNER JOIN Funcionario FD ON I.Funcionario_Digita = FD.Identificacion_Funcionario
            INNER JOIN Funcionario FC ON I.Funcionario_Cuenta = FC.Identificacion_Funcionario
            INNER JOIN Bodega B ON I.Id_Bodega = B.Id_Bodega
