...
$objSheet->getCell('F1')->setValue("PLAZO");
$objSheet->getCell('G1')->setValue("MORA");
$objSheet->getCell('H1')->setValue("SIN VENCER");
$objSheet->getCell('I1')->setValue("1 - 30");
$objSheet->getCell('J1')->setValue("31 - 60");
$objSheet->getCell('K1')->setValue("61 - 90");
$objSheet->getCell('L1')->setValue("91 - 180");
$objSheet->getCell('M1')->setValue("181 - 360");
$objSheet->getCell('N1')->setValue("MAYOR DE 360");
...
foreach($edades as $value){ $j++;
	...
	$objSheet->getCell('F'.$j)->setValue($value["Plazo"]);
	$objSheet->getCell('G'.$j)->setValue($value["Mora"]);
	
	$objSheet->getCell('H'.$j)->setValue($value["Sin_Vencer"]);
	$objSheet->getCell('I'.$j)->setValue($value["first_thirty_days"]);
	$objSheet->getCell('J'.$j)->setValue($value["thirtyone_sixty"]);
	$objSheet->getCell('K'.$j)->setValue($value["sixtyone_ninety"]);
	$objSheet->getCell('L'.$j)->setValue($value["ninetyone_onehundeight"]);
	$objSheet->getCell('M'.$j)->setValue($value["onehundeight_threehundsix"]);
	$objSheet->getCell('N'.$j)->setValue($value["mayor_threehundsix"]);
}
