...
(
    ...
    END
) AS Cantidad_Diferencial, SUM(PIF.Cantidad_Inventario) as Cantidad, PIF.Cantidad_Inventario, "" AS Cantidad_Final 
FROM Producto_Inventario_Fisico PIF 
INNER JOIN Producto P ON PIF.Id_Producto=P.Id_Producto WHERE PIF.Id_Inventario_Fisico IN ('.$id_inventario_fisico . ') 
