...
$oItem= new complex("Inventario_Fisico","Id_Inventario_Fisico",$modelo['Id_Inventario_Fisico']);
//var_dump($oItem);
...
AnularMovimientoContable($modelo['Id_Inventario_Fisico']);
...
function AnularMovimientoContable($idRegistroModulo){
    ...
    $contabilizar->AnularMovimientoContable($idRegistroModulo, 9);
}
?>