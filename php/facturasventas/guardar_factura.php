...
function guardarFactura($datos, $productos, $tipo,$mod){
   ...
   $datos['Id_Funcionario'] = $funcionario; */
    ...
    // if ($tipo == 'Factura') { // Para poder utilizar la variable cuando se registre un homologo
        ...
        $datos_movimiento_contable['Id_Punto_Dispensacion'] = $datos_dis['Id_Punto_Dispensacion'];
...
// GuardarDispensacionPortalClientes($encabezadoFactura['Id_Dispensacion']); //DESCOMENTAR ESTA LINEA PARA GUARDAR EN EL PORTAL CLIENTES
