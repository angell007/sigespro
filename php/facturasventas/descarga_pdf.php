      ...
      $cabecera2='<table style="" >
              <tbody>
                ...
                <tr>
                     ...
                     <td colspan="1" style="font-size:11px;text-align:right;">
...
foreach ($productos as $prod) {
    $iva =(str_replace("%", "", $prod["Impuesto"]) / 100);
  $total_iva += (($prod["Cantidad"] * $prod["PrecioVenta"] ) * $iva)*(1- $prod["Descuento"] / 100);
  ...
  $subtotal += $total_producto;
	        		...
	        		$ ' . number_format($prod["PrecioVenta"], 2, ",", ".") . '
	        		</td>
	             	   ...
	             	   <td rowspan="3" style="padding:4px;font-size:9px;border:1px solid #c6c6c6;width:130px;">
	             	   	<table cellpadding="0" cellspacing="0">
	             	   	   ...
	             	   	   <tr>
	             	   		...
	             	   		<td style="padding:4px;font-size:9px;width:60px;text-align:right;"><strong>$ ' . number_format($subtotal + $total_iva - $total_descuento, 2, ",", ".") . '</strong></td>
	             	   	   </tr>
	             	   	</table>
	             	   </td>
	             	</tr>
...
$content = //$style.
      '<page backtop="330px" backbottom="195px" '.$marca_agua.'>
