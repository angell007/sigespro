<?php 
    ...
    $id_inventario_fisico_nuevo=isset($_REQUEST['Id_Inventario_Fisico_Punto_Nuevo']) ? $_REQUEST['Id_Inventario_Fisico_Punto_Nuevo'] : false;
    ...
    $query='SELECT I.Fecha AS "Fecha_Realizado", E.Nombre AS "Nombre_Estiba", G.Nombre AS "Nombre_Grupo", PD.*, (PD.Segundo_Conteo - PD.Cantidad_Inventario) AS "Cantidad_Diferencial",
            ...
            INNER JOIN Doc_Inventario_Fisico_Punto DOC ON DOC.Id_Inventario_Fisico_Punto_Nuevo=I.Id_Inventario_Fisico_Punto_Nuevo
            INNER JOIN Estiba E ON E.Id_Estiba=DOC.Id_Estiba
            INNER JOIN Grupo_Estiba G ON G.Id_Grupo_Estiba=E.Id_Grupo_Estiba
            INNER JOIN Producto_Doc_Inventario_Fisico_Punto PD ON PD.Id_Doc_Inventario_Fisico_Punto= DOC.Id_Doc_Inventario_Fisico_Punto
            INNER JOIN Producto P ON  P.Id_Producto = PD.Id_Producto
            WHERE I.Id_Inventario_Fisico_Punto_Nuevo = '.$id_inventario_fisico_nuevo.'
