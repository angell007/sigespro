...
$query = "SELECT  Id_Grupo_Estiba , Id_Punto_Dispensacion
FROM Estiba
...
unset($oCon);
$idPunto = $idGrupo['Id_Punto_Dispensacion'];
...
WHERE E.Id_Grupo_Estiba = ' . $idGrupo . ' AND E.Id_Punto_Dispensacion = ' . $idPunto . ' AND E.Estado != "Inactiva"';
...
if (strlen($estibasFalt) > 0) {
  ...
  $query = 'SELECT I.Id_Doc_Inventario_Fisico_Punto , G.Id_Grupo_Estiba,G.Nombre AS "Nombre_Grupo" , E.Id_Estiba, E.Nombre AS "Nombre_Estiba", B.Id_Punto_Dispensacion, B.Nombre AS "Nombre_Bodega", PD.* , (PD.Segundo_Conteo - PD.Cantidad_Inventario) AS "Cantidad_Diferencial",  
  ...
  P.Nombre_Comercial
    ...
    INNER JOIN Producto_Doc_Inventario_Fisico_Punto PD ON PD.Id_Doc_Inventario_Fisico_Punto=I.Id_Doc_Inventario_Fisico_Punto
