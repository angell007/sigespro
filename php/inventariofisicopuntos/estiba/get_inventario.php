...
$Id_Doc_Inventario_Fisico =  ( isset( $_REQUEST['Id_Doc_Inventario_Fisico_Punto'] ) ? $_REQUEST['Id_Doc_Inventario_Fisico_Punto'] : false );

if ($Id_Doc_Inventario_Fisico) {

$query ="SELECT I.Id_Doc_Inventario_Fisico_Punto, I.Estado, I.Funcionario_Digita,I.Funcionario_Cuenta ,
     I.Fecha_Inicio, I.Lista_Productos, 
    E.Nombre AS Nombre_Estiba, E.Id_Estiba,
    B.Nombre AS  Nombre_Bodega, B.Id_Punto_Dispensacion 
    ...
    WHERE I.Id_Doc_Inventario_Fisico_Punto = $Id_Doc_Inventario_Fisico";
    ...
    if ($inv) {
        ...
        $resultado['Data']["Id_Doc_Inventario_Fisico_Punto"]=$inv['Id_Doc_Inventario_Fisico_Punto'];
