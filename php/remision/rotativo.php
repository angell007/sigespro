...
function CrearQueryMedicamentos($punto_dispensacion,$fecha_inicio, $fecha_fin, $bodega){
    ...
    GROUP BY  PRD.ATC, PRD.Cantidad, PRD.Unidad_Medida, PRD.Concentracion, PRD.Presentacion ORDER BY Formuladas DESC LIMIT 1) UNION (
    ...
    GROUP BY  PRD.Id_Producto ORDER BY Formuladas DESC LIMIT 1 ) ';
    $oCon = new consulta();
