...
if ($bodega=='1') {
    ...
    GROUP BY  PRD.ATC, PRD.Cantidad, PRD.Unidad_Medida, PRD.Concentracion, PRD.Cantidad_Presentacion ORDER BY PRD.ATC ';
    ...
    $oCon->setTipo('Multiple');
    $oCon->setQuery($query);
    $comerciales = $oCon->getData();
    unset($oCon);

    $productos=array_merge($productos,$comerciales);
    ...
    GROUP BY  PRD.ATC, PRD.Cantidad, PRD.Unidad_Medida, PRD.Concentracion ORDER BY PRD.ATC ';
