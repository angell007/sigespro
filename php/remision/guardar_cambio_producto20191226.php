...
function SetCondiciones(){
 ...
 function GetQuery(){
     ...
     $query='SELECT
         ...
         INNER JOIN (SELECT Id_Dispensacion, Numero_Documento, Fecha_Actual,Id_Punto_Dispensacion  FROM Dispensacion WHERE Estado_Dispensacion!="Anulada" AND Id_Dispensacion_Mipres=0  ) D ON PR.Id_Dispensacion=D.Id_Dispensacion
