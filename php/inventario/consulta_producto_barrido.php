<?php
    ...
    if($producto){
        if(strpos($Categoria,$producto['Id_Categoria'])===false && $Categoria!='0'){
	...
	function SetCondiciones($codigo){
        ...
        $condicion=" WHERE PRD.Codigo_Barras = '$codigo' OR I.Codigo='$codigo1' OR I.Alternativo LIKE '%$codigo1%' " ;
    ...
    function ObternerLotes($id_producto){
        ...
        FROM Inventario I
        WHERE I.Id_Producto = '.$id_producto.' AND I.Id_Bodega='.$Bodega.' AND I.Cantidad>0 ORDER BY I.Fecha_Vencimiento ASC';
