...
AND FV.Id_Factura_Administrativa ='.$id ;
...
$contenido = '<table  cellspacing="0" cellpadding="0" >
			    ...
			    $total_iva = 0;
	        	    foreach($productos as $prod){ $total_iva += ((($prod["Cantidad"]*$prod["Precio"])-($prod["Cantidad"]*$prod["Descuento"]))*(str_replace("%","",$prod["Impuesto"])/100));
	        	    $contenido.='<tr>
	             	   ...
	             	   <td rowspan="3" style="padding:4px;font-size:9px;border:1px solid #c6c6c6;width:130px;">
	             	   	<table cellpadding="0" cellspacing="0">
	             	   	   <tr>
	             	   		...
	             	   		<td style="padding:4px;font-size:9px;width:60px;text-align:right;">$ '.number_format($totalFactura['TotalFac']-$total_iva,2,",",".").'</td>
	             	   	   </tr>
	             	   	   <tr>
...
/* FIN CONTENIDO GENERAL DEL ARCHIVO MEZCLANDO TODA LA INFORMACION*/
    ...
    // LA D SIGNIFICA DESCARGAR, 'F' SE PODRIA HACER PARA DEJAR EL ARCHIVO EN UNA CARPETA ESPECIFICA
  // $html2pdf->clean();
