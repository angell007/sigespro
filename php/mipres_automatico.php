<?php
	...
	include_once('/home/sigespro/public_html/class/class.querybasedatos.php');
	include_once('/home/sigespro/public_html/class/class.http_response.php');
    include_once('/home/sigespro/public_html/class/class.mipres.php');
   ...
   $fecha_actual = date('Y-m-d'); 
    ...
    /*$fini = ( isset( $_REQUEST['fini'] ) ? $_REQUEST['fini'] : "2019-01-01" );
    $ffin = ( isset( $_REQUEST['ffin'] ) ? $_REQUEST['ffin'] : "2019-01-01" );*/
...
function GetIdProductoAsociado($cum, $tec){
    ...
    $cum2=$tem[0].'-'.(INT)$tem[1];
    $cum=str_replace('-','',$cum);
    $query="SELECT Id_Producto FROM Producto_Tipo_Tecnologia_Mipres PD INNER JOIN Tipo_Tecnologia_Mipres M ON PD.Id_Tipo_Tecnologia_Mipres=M.Id_Tipo_Tecnologia_Mipres WHERE (Codigo_Actual='$cum' OR Codigo_Anterior='$cum') AND M.Codigo='$tec' "; 
