...
FROM Inventario WHERE  Id_Punto_Dispensacion != 0 LIMIT 50000,25000";
$oCon = new consulta();
$oCon->setQuery($query);
 ...
 //echo $sql_acta_recepcion_bodegas; exit;
        $query_dispensaciones .= '
            ...
            UNION ALL (SELECT D.Id_Dispensacion AS ID, 
                 ...
                 INNER JOIN Inventario I ON PD.Id_Inventario=I.Id_Inventario
                 WHERE PD.Id_Producto = ' . $producto .' AND PD.Id_Inventario='.$prod["Id_Inventario"].' AND  PD.Cantidad_Entregada!=0 AND I.Id_Punto_Dispensacion = ' . $idTipo . '  HAVING Fecha BETWEEN "'.$fecha_inicio .' 00:00:00" AND "'.$fecha_fin .' 23:59:59")';
