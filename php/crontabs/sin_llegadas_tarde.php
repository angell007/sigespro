...
if($dia_hoy!=0&&$pos===false){
    ...
    foreach ($funcionarios as  $func) {
        $query="SELECT * FROM  Diario_Fijo WHERE Fecha=curdate() AND Identificacion_Funcionario=$func[Identificacion_Funcionario] AND (Hora_Entrada2 != '00:00:00'
		OR Hora_Entrada1 > '12:00:00' ) ";
        ...
        $query='SELECT * FROM  Novedad WHERE Identificacion_Funcionario='.$func['Identificacion_Funcionario'].' AND Fecha_Inicio<="'.date("Y-m-d").' 15:00:00" AND Fecha_Fin>="'.date("Y-m-d").' 15:00:00" ';
