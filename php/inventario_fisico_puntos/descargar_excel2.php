...
$query = 'SELECT PIF.Id_Producto_Inventario_Fisico,PIF.Cantidad_Inventario, PIF.Id_Inventario_Fisico_Punto,  P.Nombre_Comercial, CONCAT(P.Principio_Activo," ",P.Presentacion," ",P.Concentracion, P.Cantidad," ", P.Unidad_Medida, " ") AS Nombre_Producto, PIF.Lote, PIF.Fecha_Vencimiento, SUM(PIF.Primer_Conteo) AS Cantidad_Encontrada, IF(INF.Inventario="Si", PIF.Cantidad_Inventario,SUM(PIF.Segundo_Conteo)) AS Segundo_Conteo, (SELECT AVG(I.Costo) FROM Inventario_Nuevo I WHERE I.Id_Producto=PIF.Id_Producto) as Costo
, IF(INF.Inventario="Si", (SUM(PIF.Cantidad_Final)-PIF.Cantidad_Inventario), SUM(PIF.Segundo_Conteo-PIF.Primer_Conteo) ) AS Cantidad_Diferencial, SUM(PIF.Cantidad_Final) as Cantidad_Final,P.Codigo_Cum, P.Invima 
FROM Producto_Inventario_Fisico_Punto PIF INNER JOIN Producto P ON PIF.Id_Producto=P.Id_Producto INNER JOIN Inventario_Fisico_Punto INF ON PIF.Id_Inventario_Fisico_Punto=INF.Id_Inventario_Fisico_Punto WHERE PIF.Id_Inventario_Fisico_Punto IN ('.$datos['Inventarios'].') GROUP BY PIF.Id_Producto,PIF.Id_Inventario,PIF.Lote ORDER BY P.Nombre_Comercial';
