...
$query3 = 'SELECT 
          ...
          on P.Id_Producto=I.Id_Producto AND I.Id_Punto_Dispensacion = '.$punto.'
          INNER JOIN Producto_Contrato
          ON P.Codigo_Cum = Producto_Contrato.Cum AND Producto_Contrato.Id_Contrato = '.$contrato["Id_Contrato"].'
          WHERE I.Cantidad>0
          AND CONCAT_WS(" ",
            P.Nombre_Comercial, " - ",
            P.Principio_Activo,
