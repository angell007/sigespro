...
$oItem = new complex('Factura_Administrativa','Id_Factura_Administrativa', $id_registro);
$datos = $oItem->getData();
unset($oItem);
...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    $query = '
        SELECT
            ...
            "Factura Administrativa" AS Registro
        FROM Movimiento_Contable MC
        INNER JOIN Plan_Cuentas PC ON MC.Id_Plan_Cuenta = PC.Id_Plan_Cuentas
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 35 AND Id_registro_Modulo ='.$id_registro.' ORDER BY Debe DESC';
    ...
    $query = '
        ...
        FROM Movimiento_Contable MC
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 35 AND Id_registro_Modulo ='.$id_registro;
