...
$oItem = new complex('Nota_Credito_Global','Id_Nota_Credito_Global', $id_registro);
$datos = $oItem->getData();
unset($oItem);
...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    $query = '
        ...
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 34 AND Id_registro_Modulo ='.$id_registro.' ORDER BY Debe DESC';
    ...
    $query = '
        ...
        FROM Movimiento_Contable MC
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 34 AND Id_registro_Modulo ='.$id_registro;
    ...
    unset($queryObj);
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">Nota Crédito</h4>
