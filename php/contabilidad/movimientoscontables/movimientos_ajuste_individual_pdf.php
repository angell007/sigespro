...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    unset($queryObj);
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">Ajuste Individual</h4>
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">'.$datos['Codigo'].'</h4>
            <h5 style="margin:5px 0 0 0;font-size:16px;line-height:16px;">Fecha '.fecha($datos['Fecha']).'</h5>
        ';
