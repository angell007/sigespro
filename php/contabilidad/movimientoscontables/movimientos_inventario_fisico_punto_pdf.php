...
$oItem = new complex('Inventario_Fisico_Punto','Id_Inventario_Fisico_Punto', $id_registro);
$datos = $oItem->getData();
unset($oItem);
...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    $query = '
        ...
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 10 AND Id_registro_Modulo ='.$id_registro.' ORDER BY Debe DESC';
    ...
    $query = '
        ...
        FROM Movimiento_Contable MC
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 10 AND Id_registro_Modulo ='.$id_registro;
    ...
    $query = '
        ...
        FROM Funcionario
        WHERE
            Identificacion_Funcionario ='.$datos['Funcionario_Cuenta'];
    ...
    unset($queryObj);
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">Inventario Físico Punto</h4>
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">INVFP'.$id_registro.'</h4>
            <h5 style="margin:5px 0 0 0;font-size:16px;line-height:16px;">Fecha '.fecha($datos['Fecha_Fin']).'</h5>
        ';
