...
$oItem = new complex('Liquidacion_Funcionario','Id_Liquidacion_Funcionario', $id_registro);
$datos = $oItem->getData();
unset($oItem);
...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    $query = '
        ...
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 21 AND Id_registro_Modulo ='.$id_registro.' ORDER BY Debe DESC';
    ...
    $query = '
        ...
        FROM Movimiento_Contable MC
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 21 AND Id_registro_Modulo ='.$id_registro;
    ...
    $query = '
        ...
        FROM Funcionario
        WHERE
            Identificacion_Funcionario ='.$datos['Funcionario'];
