...
$oItem = new complex('Factura_Capita','Id_Factura_Capita', $id_registro);
$datos = $oItem->getData();
unset($oItem);
...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    $query = '
        ...
        MC.Haber_Niif,
            ...
            "Factura Capita" AS Registro
        FROM Movimiento_Contable MC
        INNER JOIN Plan_Cuentas PC ON MC.Id_Plan_Cuenta = PC.Id_Plan_Cuentas
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 3 AND Id_registro_Modulo ='.$id_registro.' ORDER BY Debe DESC';
    ...
    $query = '
        ...
        FROM Movimiento_Contable MC
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 3 AND Id_registro_Modulo ='.$id_registro;
    ...
    unset($queryObj);
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">Factura Capita</h4>
