...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    unset($queryObj);
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">Acta Recepción</h4>
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">'.getCodigoActa($id_registro).'</h4>
