...
$oItem = new complex('Inventario_Fisico','Id_Inventario_Fisico', $id_registro);
$datos = $oItem->getData();
unset($oItem);
...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    $query = '
        ...
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 9 AND Id_registro_Modulo ='.$id_registro.' ORDER BY Debe DESC';
    ...
    $query = '
        ...
        FROM Movimiento_Contable MC
        WHERE
            MC.Estado = "Activo" AND Id_Modulo = 9 AND Id_registro_Modulo ='.$id_registro;
    ...
    unset($queryObj);
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">Inventario Físico</h4>
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">INVF'.$id_registro.'</h4>
