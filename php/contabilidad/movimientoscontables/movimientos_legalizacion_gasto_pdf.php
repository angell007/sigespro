...
$oItem = new complex('Gasto_Punto','Id_Gasto_Punto', $id_registro);
$datos = $oItem->getData();
unset($oItem);
...
/* HAGO UN SWITCH PARA TODOS LOS MODULOS QUE PUEDEN GENERAR PDF */
    ...
    $query = '
        ...
        WHERE
          Id_Modulo = 32 AND Id_registro_Modulo ='.$id_registro.' ORDER BY Debe DESC';
    ...
    $query = '
        ...
        FROM Movimiento_Contable MC
        WHERE
         Id_Modulo = 32 AND Id_registro_Modulo ='.$id_registro;
  ...
  //  $imprime = $queryObj->ExecuteQuery('simple');
    ...
    unset($queryObj);
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">Legalización Gastos</h4>
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">'.$datos['Codigo_Legalizacion'].'</h4>
    ...
    <tr>
        ...
        <td style="width:160px;font-weight:bold;background:#cecece;text-align:center;border:1px solid #cccccc;">
