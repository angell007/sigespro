...
$content = file_get_contents("./reportes/640f5897adc45.html");

try {
  /* CREO UN PDF CON LA INFORMACION COMPLETA PARA DESCARGAR*/
  $html2pdf = new HTML2PDF('P', 'A4', 'Es', true, 'UTF-8', array(5, 5, 5, 5));
  $html2pdf->writeHTML($content);
  $direc = 'Libro_Auxiliar.pdf'; // NOMBRE DEL ARCHIVO ES EL CODIGO DEL DOCUMENTO
...
if ($tipo == 'Nit') {
    ...
    foreach ($cuentas as $i => $cuenta) {
      ...
      <tr style="font-size:9px">
        ...
        <td style="width:80px;max-width:80px;word-wrap:break-word;padding:5px;background:#c3c4c5"></td>
      </tr>
      ';
