...
require_once('../../class/class.configuracion_test.php');
include_once('../../class/class.consulta.php');
require_once('../../class/class.qr.php');  /* AGREGAR ESTA CLASE PARA GENERAR QR */
include_once('../../class/class.contabilizar.php');
include_once('./helper.ajuste_individual.php');
//ublic_html/class/cass.configuracion_test.php
...
if ( $tipo_ajuste == "Salida" || $tipo_ajuste=="Cambio" ) {
 ...
 // var_dump($cod);exit;
  ...
  if ($id_ajuste) {
    guardarActividad($id_ajuste,$funcionario,'Se creó la salida del ajuste individual '.$cod, 'Creacion');
  }
  /* AQUI GENERA QR 
