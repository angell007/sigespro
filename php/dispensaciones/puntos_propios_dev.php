...
$query = 'SELECT FP.*, PD.Nombre as Nombre_Punto, PD.Cajas, PD.Turnero, PD.NO_POS, (SELECT PT.Id_Turneros FROM Punto_Turnero PT WHERE PT.Id_Punto_Dispensacion=PD.Id_Punto_Dispensacion LIMIT 1 ) as Turneros
