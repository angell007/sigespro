<?php
    ...
    $query = 'SELECT PNA.Id, 
                ...
                WHERE PNA.Estado = "Radicado" AND PNA.Estado_No_Autorizado = "Aceptada"  '.$condicion.' ORDER BY PNA.id DESC  ' ;
    ...
    $query_count='SELECT COUNT(PNA.Id) AS Total
                        ...
                        INNER JOIN Departamento D ON PD.Departamento = D.Id_Departamento
                        INNER JOIN Municipio M ON M.Id_Municipio = PD.Municipio
                        WHERE PNA.Estado = "Radicado" AND PNA.Estado_No_Autorizado = "Aceptada"  '.$condicion.' ' ;
