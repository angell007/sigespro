...
$pie='<table cellspacing="0" cellpadding="0" style="text-transform:uppercase;margin-top:10px;">
	...
	<tr>
		<td style="font-size:10px;width:770px;background:#f3f3f3;vertical-align:middle;padding:5px;height:40px;">
			...
			Autorizacion de Facturacion Electronica # '.$fact["Resolucion"].'<br>
...
$contenido = '<table  cellspacing="0" cellpadding="0" >
	        	    ...
	        	    foreach($productos as $prod){ 
	        	    	$contenido.='<tr>
	        		<td style="padding:4px;font-size:9px;text-align:left;border:1px solid #c6c6c6;width:515px;vertical-align:middle;">
                    '.$prod["Descripcion"].'<br>
	        		</td>
	        		<td style="padding:4px;font-size:9px;text-align:center;border:1px solid #c6c6c6;width:30px;vertical-align:middle;">
	        		'.number_format($prod["Cantidad"],0,"",".").'
	        		</td>
	        		<td style="padding:4px;font-size:9px;text-align:right;border:1px solid #c6c6c6;vertical-align:middle;width:80px;">
	        		$ '.number_format($prod["Precio"],2,",",".").'
	        		</td>
	        		<td style="padding:4px;font-size:9px;text-align:right;border:1px solid #c6c6c6;width:80px;vertical-align:middle;">
	             ...
	             <table style="margin-top:10px;margin-bottom:0;">
	             	<tr>
	             	   <td colspan="2" style="padding:4px;font-size:9px;border:1px solid #c6c6c6;width:536px;"><strong>Valor a Letras:</strong><br>'.$letras.' PESOS MCTE</td>
	             	   <td rowspan="3" style="padding:4px;font-size:9px;border:1px solid #c6c6c6;width:160px;">
	             	   	<table cellpadding="0" cellspacing="0">
	             	   	   <tr>
	             	   		<td style="padding:4px;font-size:9px;width:80px;"><strong>Subtotal</strong></td>
	             	   		<td style="padding:4px;font-size:9px;width:80px;text-align:right;">$ '.number_format($subtotal,2,",",".").'</td>
	             	   	   </tr>
	             	   	   <tr>
	             	   		<td style="padding:4px;font-size:9px;width:80px;"><strong>Cuotas Moderadora</strong></td>
	             	   		<td style="padding:4px;font-size:9px;width:80px;text-align:right;">$ '.number_format($cliente['Cuota_Moderadora'],2,",",".").'</td>
	             	   	   </tr>
	             	   	   <tr>
	             	   		<td style="padding:4px;font-size:9px;width:80px;"><strong>Total</strong></td>
	             	   		<td style="padding:4px;font-size:9px;width:80px;text-align:right;"><strong>$ '.number_format($total,2,",",".").'</strong></td>
	             	   	   </tr>
	             	   	</table>
	             	   </td>
	             	</tr>
	             	<tr>
	             	   <td style="padding:4px;font-size:9px;border:1px solid #c6c6c6;width:446px;">
...
$content = '<page backtop="280px" backbottom="185px">
