...
require('../../config/start.inc.php');
include('../../class/class.lista.php');
include('../../class/class.complex.php');
include('../../class/class.consulta.php');
require('../../class/html2pdf.class.php');
include('../../class/NumeroALetra.php');
...
$query = 'SELECT 
       ...
       ON I.Id_Inventario = PD.Id_Inventario  WHERE PFV.Id_Factura =  '.$id ;
$oCon= new consulta();
$oCon->setQuery($query);
...
$pie='<table cellspacing="0" cellpadding="0" style="text-transform:uppercase;margin-top:4px;">
	...
	<tr>
		<td style="font-size:7px;width:778px;background:#f3f3f3;vertical-align:middle;padding:1px 5px;height:10px;">
			<strong>Resolución Facturación:</strong> Autorizacion de Facturacion Electrónica # '.$fact["Resolucion"].' Desde '.fecha($fact["Fecha_Inicio"]).' Hasta '.fecha($fact["Fecha_Fin"]).' Habilita Del No. '.$fact["Numero_Inicial"].' Al No. '.$fact["Numero_Final"]. ' Actividad economica principal 4645<br>
		</td>
...
$content = '<page backtop="250px" backbottom="105px" '.$marca_agua.'>
