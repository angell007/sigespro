...
ORDER BY MC.Fecha_Movimiento
        ...
        $codigos ='
            ...
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">CLIENTES</h4>
    ...
    <tr>
        <td style="width:70px;font-weight:bold;text-align:center;background:#cecece;;border:1px solid #cccccc;">
            CLIENTE
        </td>
        <td style="width:280px;font-weight:bold;background:#cecece;text-align:center;border:1px solid #cccccc;">
           RAZÓN SOCIAL
        </td>
    ...
    foreach ($edades as $edad) {
        ...
        $contenido .= '<tr>
        <td style="width:70px;padding:1px;text-align:center;border:1px solid #cccccc;">
            '.$edad['Nit'].'
        </td>
        <td style="width:280px;text-align:center;padding:1px;border:1px solid #cccccc;">
            '.$edad['Nombre_Cliente'].'
        </td>
    ...
    $contenido .= '<tr>
    <td colspan="2" style="padding:1px;text-align:left;border:1px solid #cccccc;font-weight:bold;font-size:12px">Totales:</td>
