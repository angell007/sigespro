...
header('Content-Disposition: attachment;filename="Saldos_Cliente.xls"');
...
/* FIN DATOS GENERALES DE CABECERAS Y CONFIGURACION */
        ...
        $codigos ='
            <h4 style="margin:5px 0 0 0;font-size:19px;line-height:22px;">SALDO CLIENTE</h4>
    ...
    $contenido = '
        <table style="border-collapse:collapse;border:1px solid #000;">
            <tr>
                <td colspan="4"><strong>SALDO CLIENTE</strong> | Fecha Corte. '.fecha($_REQUEST['fechas']).'</td>
            </tr>
...
CONCAT_WS(' ',
    ...
    C.Primer_Apellido,
    C.Segundo_Apellido),
C.Razon_Social) AS Nombre_Cliente, (SELECT Nombre FROM Municipio WHERE Id_Municipio = C.Id_Municipio) AS Municipio FROM Cliente C WHERE Id_Cliente = $_REQUEST[cliente]";
