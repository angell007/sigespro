...
switch($tipoCompra){
    ...
    case "Nacional":{
        $query = 'SELECT  COUNT(*) as Total_Items
           ...
           $query1 ="SELECT 'Nacional' AS Tipo, OCN.Id_Orden_Compra_Nacional AS Id_Orden_Compra, OCN.Codigo, OCN.Identificacion_Funcionario, 
           OCN.Id_Bodega_Nuevo, (SELECT P.Nombre FROM Proveedor P WHERE P.Id_Proveedor=OCN.Id_Proveedor) AS Proveedor, OCN.Id_Proveedor,
