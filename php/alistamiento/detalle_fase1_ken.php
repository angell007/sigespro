...
$condicion_principal=' WHERE R.Tipo_Origen="Bodega" AND R.Estado_Alistamiento = 0 AND R.Estado ="Pendiente" AND (R.Fase_1="0" OR R.Fase_1="'.$funcionario.'") AND R.Id_Origen IN ('.$bodegas_funcionarios.')';
$condicion_destino='';
if($r['puntos']){
  $condicion_destino .= " AND R.Tipo_Destino = 'Punto_Dispensacion' AND R.Id_Destino IN (".$r['puntos'].") ";
}

$condicion_cliente .= " AND (R.Tipo_Destino = 'Cliente' OR R.Tipo_Destino='Bodega'  )";
