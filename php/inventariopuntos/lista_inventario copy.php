...
$query .= $condicion_principal . ' ' . $condicion . $condicion_sin_inventario . ' GROUP BY B.Id_Bodega_Nuevo, I.Id_Producto,I.Lote,I.Fecha_Vencimiento, I.Codigo_Cum' . ' ORDER BY PRD.Nombre_Comercial LIMIT ' . $limit . ',' . $tamPag;
