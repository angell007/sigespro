...
if (isset($_REQUEST['id']) && ($_REQUEST['id'] != "" && $_REQUEST['id'] != "0")) {
    $condicion_principal .=  ' WHERE  B.Id_Punto_Dispensacion =' . $_REQUEST['id'];
    // $condicion_principal .=  ' AND B.Id_Punto_Dispensacion =' . $_REQUEST['id'];
} else {
    $condicion_principal .=  ' AND B.Id_Id_Punto_Dispensacion != 0  ';
}
...
' GROUP BY B.Id_Punto_Dispensacion, I.Id_Producto,I.Lote,I.Fecha_Vencimiento, I.Codigo_Cum' . ' ORDER BY PRD.Nombre_Comercial LIMIT ' . $limit . ',' . $tamPag;
