...
$final['Mayor']=AdultoMayor();
	...
	$final["Cedula"] = '';
	$final["Solicitar"] = "No";
	$final["Mensaje"]="Ha ocurrido un error al procesar su documento de identidad. Por favor intentelo de nuevo.";
}
...
function AdultoMayor(){
	global $datos;
	$fecha =substr($datos["Nacimiento"],0,4)."-".substr($datos["Nacimiento"],4,2)."-".substr($datos["Nacimiento"],6,2);
