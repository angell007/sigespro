...
$query = 'SELECT P.Nombre_Comercial,
          IF(CONCAT( P.Principio_Activo, " ",
                  ...
                  P.Concentracion, " (", P.Nombre_Comercial,") ",
                  P.Cantidad," ",
                  P.Unidad_Medida, " LAB-", P.Laboratorio_Comercial )) as Nombre, P.Nombre_Comercial, P.Laboratorio_Comercial, P.Id_Producto, P.Embalaje, IFNULL(P.Laboratorio_Generico, "No aplica") AS Laboratorio_Generico FROM Producto P '.$condicion .' GROUP BY P.Id_Producto';
