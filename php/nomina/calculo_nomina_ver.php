...
WHERE ME.Identificacion_Funcionario=F.Identificacion_Funcionario AND ME.Tipo="Ingreso" AND TI.Tipo="Prestacional" AND ME.Quincena="'.$quincena.'") as Ingresos_S,

(Select SUM(Valor) 
FROM Movimiento_Funcionario ME 
INNER JOIN Tipo_Ingreso TI ON ME.Id_Tipo=TI.Id_Tipo_Ingreso 
WHERE ME.Identificacion_Funcionario=F.Identificacion_Funcionario AND ME.Tipo="Ingreso" AND TI.Tipo="No_Prestacional" AND ME.Quincena="'.$quincena.'") as Ingresos_N,

(Select SUM(Valor) 
FROM Movimiento_Funcionario ME 
WHERE ME.Identificacion_Funcionario=F.Identificacion_Funcionario AND ME.Tipo="Egreso" AND ME.Quincena="'.$quincena.'") as Egresos,
...
ON TI.Id_Tipo_Ingreso = MF.Id_Tipo AND MF.Tipo="Ingreso" AND MF.Identificacion_Funcionario='.$id.' AND MF.Quincena="'.$quincena.'"
...
FROM Tipo_Egreso TE
LEFT JOIN Movimiento_Funcionario MF
ON TE.Id_Tipo_Egreso = MF.Id_Tipo AND MF.Tipo="Egreso" AND MF.Identificacion_Funcionario='.$id.' AND MF.Quincena="'.$quincena.'"
';     
$oCon= new consulta();
$oCon->setTipo('Multiple');
...
$funcionario["Auxilio_No_Salarial"]=(INT)$funcionario["Auxilio_No_Salarial"]/2;
