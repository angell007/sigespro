...
INNER JOIN Punto_Dispensacion B ON
 B.Id_Punto_Dispensacion = E.Id_Punto_Dispensacion
...
--  LEFT JOIN Producto_Lista_Ganancia PLG ON
-- PRD.Codigo_Cum = PLG.Cum

' . $condicion_principal . ' ' . $condicion  .$condicion_sin_inventario. ' GROUP BY B.Id_Punto_Dispensacion, 
I.Id_Producto,I.Lote,I.Fecha_Vencimiento, PRD.Codigo_Cum, GE.Id_Grupo_Estiba ';
...
if ($_REQUEST['lista'] != '') {
    # code...
    // $listaLeft = 'LEFT JOIN Producto_Lista_Ganancia PLG ON
    // PRD.Codigo_Cum = PLG.Cum ';
    // $listaSelect = ' IFNULL(PLG.Precio, 0) AS Precio_Lista, ';
}
...
$query .= $condicion_principal . ' ' . $condicion . $condicion_sin_inventario . ' GROUP BY B.Id_Punto_Dispensacion, 
I.Id_Producto,I.Lote,I.Fecha_Vencimiento, PRD.Codigo_Cum, GE.Id_Grupo_Estiba' . ' ORDER BY PRD.Nombre_Comercial LIMIT ' . $limit . ',' . $tamPag;
