...
$query = 'SELECT COUNT(*) AS Total
        ...
        WHERE ARC.Id_Punto_Dispensacion='.$id_punto.$condicion;
...
INNER JOIN Remision R
ON ARC.Id_Remision=R.Id_Remision
WHERE ARC.Id_Punto_Dispensacion='.$id_punto.$condicion.' ORDER BY Fecha DESC, Codigo DESC LIMIT '.$limit.','.$tamPag;
