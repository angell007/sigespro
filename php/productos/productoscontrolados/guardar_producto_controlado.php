<?php
	...
	$oItem= new complex("Producto_Control_Cantidad","Id_Producto_Control_Cantidad");
    ...
    $http_response->SetRespuesta(0, 'Registro Exitoso', 'Se ha registrado la configuracion de cantidades exitosamente!');
