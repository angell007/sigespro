...
try {
	...
	$respuesta = array('tipo'=>'error', 'mensaje'=>'ocurrió un error al cargar el archivo', 'titulo'=>'Error');
	echo json_encode($respuesta); exit;
}
if(!$nombre_archivo){
	$respuesta = array('tipo'=>'error', 'mensaje'=>'Debe seleccionar un archivo válido', 'titulo'=>'Error');
}

$oItem= new complex("Producto_Agotado","Id_Producto_Agotado", $datos['Id_Producto_Agotado']);
