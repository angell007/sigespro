...
$query = 'SELECT COUNT(*) AS Total FROM Remision_Antigua ' . $condicion;
...
$query = 'SELECT *, DATE_FORMAT(Fecha, "%d/%m/%Y") AS Fecha_Remision FROM Remision_Antigua '.$condicion.' ORDER BY Fecha DESC, Codigo DESC LIMIT '.$limit.','.$tamPag;
